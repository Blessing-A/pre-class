...
for (i in colnames (WCGS.new)) {#Used the for loop to assign i to variables in the colnames of the WCGS.new dataset
  WCGS.new_mean_sd <- c(mean(WCGS.new [,i], na.rm = TRUE),  sd(WCGS.new [,i], na.rm = TRUE)) #used to cantenation sign to combine the commands for finding the mean and standard deviation for iteration of all the numeric colnames in the WCGS.new dataset. Wraped the commands to a vector name.
